...
public class Jaxb2Marshaller implements MimeMarshaller, MimeUnmarshaller, GenericMarshaller, GenericUnmarshaller,
	...
	public boolean supports(Class<?> clazz) {
		logger.debug("this.supportJaxbElementClass["+this.supportJaxbElementClass+"],["+JAXBElement.class.isAssignableFrom(clazz)+"],["+supportsInternal(clazz, this.checkForXmlRootElement)+"]");
