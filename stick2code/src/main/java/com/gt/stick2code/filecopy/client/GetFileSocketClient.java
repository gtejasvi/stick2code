...
public class GetFileSocketClient extends Thread {
	...
	public GetFileSocketClient(String host, int port, FileCopyParameters fileCopyParameters,
			 int threads) {
		this.host = host;
		this.port = port;
	...
	public static void main(String[] arg) throws IOException,
		...
		String usage = "Usage : <Host> <Port> <Src file/folder> <Targer file/Folder> <[threads]> <[max file chunk]> [ -[r/R recursive][-o/O overwrite]]";
		...
		GetFileSocketClient client = new GetFileSocketClient(host,
				port, fileCopyParameters, threads);
		client.process();
	}
